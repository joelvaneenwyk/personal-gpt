...
| path         | Persistence path for QdrantLocal. Eg. `local_data/personal_gpt/qdrant`|
...
```yaml
qdrant:
  path: local_data/personal_gpt/qdrant
```
...
| **schema_name** | The database schema to use. Default is `personal_gpt`       |
